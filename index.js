...
╭─〔 *🤖 WHITESHADOW MD 👑️* 〕  
├─▸ *Simplicity. Speed. Power. BY WHITESHADOW |*  
╰─➤ *Your New WhatsApp Sidekick is Here!*

*❤️ Thank you for Choosing WHITESHADOW MD!*

╭──〔 🔗 *Quick Links* 〕  
├─ 📢 *Join Our Channel:*  
│   Click [**Here**](https://whatsapp.com/channel/0029Vak4dFAHQbSBzyxlGG13) to join!  
├─ ⭐ *Give Us a Star:*  
│   Star Us [**Here**](https://github.com/CNWMD7/WHITESHADOW-MD)!  
╰─🛠️ *Prefix:* \`${prefix}\`

> _© MADE BY WHITESHADOW_`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/0q4pwo.jpg` }, caption: up })
  }
  })
...
if (!isReact && senderNumber === botNumber) {
  ...
  app.get("/", (req, res) => {
  res.send("WHITESHADOW-MD IS STARTED ✅");
  });
