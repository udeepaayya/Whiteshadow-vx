...
cmd({
    pattern: "roast",
    desc: "Roast someone in Singlish",
    category: "fun",
    react: "🔥",
    filename: __filename,
    use: "@tag"
    ...
    let roasts = [
        "Ado machan, oyage IQ wifi signal ekata wada adui!",
        "Malli, oyage soch ekka WhatsApp status wage, 24 hours pisse delete wenawa!",
        "Ado, oyage dimaag ekka 2G sim card wage slow!",
        "Oyata Google search karuwath monawada hoyaganna denne na ban!",
        "Oya NASA scientist ekek wage hithanne, eth ehema ne ban!",
        "Overthink karapan ban, oyage battery down wenawa!",
        "Oya walking meme ekak wage ban!",
        "Malli, oyage ideas Windows XP wage old!",
        "Oyage brain ekka broken link ekak wage, connect wenne na!",
        "Tika slow ban, Google ekath confuse wenawa oyage soch walata!",
        "Oya 404 not found wage ban, me duniaata extra!",
        "Oyage face ekata loading kiyanawa, eth complete wenne na!",
        "Oya hero wage hithanne, eth reality eke villain ban!",
        "Oyage life ekata error page ekak one ban!",
        "Oyage app ekath crash wenawa need wenakan!",
        "Oyage soch ekka buffering ban!",
        "Life decisions KBC host ekath confuse karai ban!",
        "Oyage brain ekka dead battery ekak wage, recharge kalayuthu ban!",
        "Oya walking error message ekak wage ban!",
        "Oya VIP ne ban, Very Idiotic Person ban!"
    ];               
    ...
    if (!mentionedUser) {
        return reply("Usage: .roast @user (Tag karapan roast karanna!)");
    }

    let target = `@${mentionedUser.split("@")[0]}`;
    
    // Sending the roast message with the mentioned user
    let message = `${target} :\n *${randomRoast}*\n> Just fun ban! Seriously ganne epa!`;
